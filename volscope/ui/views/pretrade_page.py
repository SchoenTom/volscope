...
def _render_paper_mode_banner() -> None:
    ...
    render_html(
        ...
        f'bot_trades</code> as <span style="color:{accent};">'
        f'PROPOSED</span>. No IBKR call, no real money. Live trading '
        f'is Phase 4 (≥ 100 closed paper trades + operator opt-in).'
        f'</div>'
        f'</div>'
        f'<div>'
        f'</div>'
